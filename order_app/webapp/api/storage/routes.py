...
def get_by_price_between(storage_service: StorageService = Provide[Container.storage_service]):
    ...
    max_price = request.args.get("max",default=9999999999, type=int)

    storages = storage_service.get_by_qty_between(min_price, max_price)
